...
async def search(keyword: str, retmax: int = 50) -> list:
    ...
    # Resolve journal names to ISSNs
...
def _parse_pubmed_xml(xml: str, expected_ids: list[str]) -> list:
    ...
    for block in articles:
        ...
        # Full journal name from inside <Journal> block
        jblock = _extract_tag(block, "Journal")
        journal_full = _extract_tag(jblock, "Title") if jblock else ""
